...
class AppleRemindersClient(Client):
    ...
    def __init__(
        self, lists=None, include_completed=False, exclude_lists=None, due_only=False
    ):
        try:
    ...
    def get_reminders(self):
        ...
        for reminder_list in target_lists:
            try:
                ...
                log.error(
                    f"Failed to get reminders from list '{reminder_list.name}': {e}"
                )
                continue
...
class AppleRemindersIssue(Issue):
    ...
    UDAS = {
        ...
        COMPLETED: {"type": "numeric", "label": "Apple Reminders Completed"},
        ...
        PRIORITY: {"type": "numeric", "label": "Apple Reminders Priority"},
        LIST_NAME: {"type": "string", "label": "Apple Reminders List"},
        URL: {"type": "string", "label": "Apple Reminders URL"},
        FLAGGED: {"type": "numeric", "label": "Apple Reminders Flagged"},
    }
...
class AppleRemindersService(Service):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.client = AppleRemindersClient(
            ...
            exclude_lists=list(self.config.exclude_lists)
