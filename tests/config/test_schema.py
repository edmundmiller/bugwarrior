...
class TestOracleUrl(unittest.TestCase):
    def test_oracle_url_direct(self):
        """Regular URLs pass through validation."""
        result = schema.OracleUrl._validate("https://example.com/", None)
        self.assertEqual(result, "https://example.com")

    def test_oracle_url_eval(self):
        """@oracle:eval: values are evaluated before URL validation."""
        result = schema.OracleUrl._validate(
            "@oracle:eval:echo https://example.com", None
        )
        self.assertEqual(result, "https://example.com")
